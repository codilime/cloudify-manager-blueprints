...
[ -z ${DSL_PARSER_SOURCE_URL} ] || install_module ${DSL_PARSER_SOURCE_URL} ${REST_SERVICE_VIRTUALENV}
[ -z ${REST_CLIENT_SOURCE_URL} ] || install_module ${REST_CLIENT_SOURCE_URL} ${REST_SERVICE_VIRTUALENV}
[ -z ${SECUREST_SOURCE_URL} ] || install_module ${SECUREST_SOURCE_URL} ${REST_SERVICE_VIRTUALENV}
[ -z ${PLUGINS_COMMON_SOURCE_URL} ] || install_module ${PLUGINS_COMMON_SOURCE_URL} ${REST_SERVICE_VIRTUALENV}
[ -z ${SCRIPT_PLUGIN_SOURCE_URL} ] || install_module ${SCRIPT_PLUGIN_SOURCE_URL} ${REST_SERVICE_VIRTUALENV}
[ -z ${DIAMOND_PLUGIN_SOURCE_URL} ] || install_module ${DIAMOND_PLUGIN_SOURCE_URL} ${REST_SERVICE_VIRTUALENV}
[ -z ${AGENT_SOURCE_URL} ] || install_module ${AGENT_SOURCE_URL} ${REST_SERVICE_VIRTUALENV}
